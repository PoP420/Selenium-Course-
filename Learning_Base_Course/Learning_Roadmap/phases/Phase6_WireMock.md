...
- Understand Selenium Manager's driver resolution and offline fallback behavior in Java.
- Install and run WireMock locally to stub backend API responses.
...
- Install and run locally (Java JAR or Docker).
...
```json
{
  ...
  "response": {
    ...
    "jsonBody": { "token": "abc123", "user": "admin" }
  }
}
```
...
2. Install WireMock and start it locally:
